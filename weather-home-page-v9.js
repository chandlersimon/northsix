...
displayWeather: function(data) {
	...
	document.querySelector(".tempe.one")[0].innerText = Math.round(temp) + "°F";
	document.querySelector(".tempe.one")[1].innerText = Math.round(temp) + "°F";},
};
...
displayWeather: function(data2) {
	...
	document.querySelector(".tempe.two")[0].innerText = Math.round(temp) + "°F";
	document.querySelector(".tempe.two")[1].innerText = Math.round(temp) + "°F";},
};
